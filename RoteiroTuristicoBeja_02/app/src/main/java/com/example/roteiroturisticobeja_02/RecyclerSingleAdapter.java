...
public class RecyclerSingleAdapter extends RecyclerView.Adapter<RecyclerSingleAdapter.MyViewHolder> {
    private List<Monuments> monumentsList;
    private Context context;

    public RecyclerSingleAdapter(Context ct, List<Monuments> monumentsList){
    ...
    @NonNull
    @Override
    public RecyclerSingleAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view= inflater.inflate(R.layout.my_row, parent, false);
        return new RecyclerSingleAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerSingleAdapter.MyViewHolder holder, int position) {
